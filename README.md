# nvim-treesitter-queries-foam

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-foam/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-foam/actions/workflows/validate.yml)

Neovim tree-sitter queries for **foam**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-foam",
...
- [ ] Changes are scoped to `foam` — do not include files for other languages
